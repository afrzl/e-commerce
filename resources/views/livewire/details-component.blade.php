                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            ...
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-1.jpg"
                                                    alt="{{ $product->name }}">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-3.jpg"
                                                    alt="{{ $product->name }}">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-4.jpg"
                                                    alt="{{ $product->name }}">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-5.jpg"
                                                    alt="{{ $product->name }}">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-6.jpg"
                                                    alt="{{ $product->name }}">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-7.jpg"
                                                    alt="{{ $product->name }}">
                                            </figure>
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-2.jpg"
                                                    alt="{{ $product->name }}"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-1.jpg"
                                                    alt="{{ $product->name }}"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-3.jpg"
                                                    alt="{{ $product->name }}"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-4.jpg"
                                                    alt="{{ $product->name }}"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-5.jpg"
                                                    alt="{{ $product->name }}"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-6.jpg"
                                                    alt="{{ $product->name }}"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/product-')}}{{ $product->id }}-7.jpg"
                                                    alt="{{ $product->name }}"></div>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ route('product.details', ['slug' => $rproduct->slug]) }}" tabindex="0">{{$product->name}}</a></h2>
